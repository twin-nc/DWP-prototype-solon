...
- **Escalate / hand off when:**
  - to `DEVOPS-RELEASE-ENGINEER.md` when release evidence or CI-gate outputs are central
  - to `SOLUTION-ARCHITECT.md` when traceability gaps reflect architecture or contract gaps
  - to `BUSINESS-ANALYST.md` when intended behavior or requirement source is unclear
  - to `DESIGN-CRITIC.md` when hidden design assumptions break traceability
