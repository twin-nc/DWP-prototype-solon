...
- **Primary agent:** `CODE-REVIEWER.md`
...
- **Escalate / hand off when:**
  - to `SOLUTION-ARCHITECT.md` when the PR implies architectural or boundary changes beyond the stated scope
  - to `TAX-DOMAIN-EXPERT.md` when correctness depends on tax or policy interpretation
  - to `DB-DESIGNER.md` when migrations, data lineage, or immutable-history handling are central
  - to `TEST-DESIGNER.md` when concerns are mostly about missing coverage or weak verification strategy
  - to `DEVOPS-RELEASE-ENGINEER.md` when rollout, CI, environment, or release-gate concerns are central
  - to `DESIGN-CRITIC.md` when the change appears to rest on risky or contradictory design assumptions
  - to `REFACTORER.md` when the main follow-up is structural cleanup rather than defect risk
