...
- **Escalate / hand off when:**
  - to `DEVOPS-RELEASE-ENGINEER.md` when operational recovery and observability dominate
  - to `BACKEND-BUILDER.md` when the main next step is implementing the recovery logic
  - to `TEST-DESIGNER.md` when the next step is coverage design for retries and reconciliation
