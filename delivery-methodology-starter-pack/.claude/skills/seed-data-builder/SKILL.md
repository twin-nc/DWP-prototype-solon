...
- **Escalate / hand off when:**
  - to `DB-DESIGNER.md` when fixture realism depends on data-model constraints
  - to `BUSINESS-ANALYST.md` when example scenarios or actors are unclear
  - to `DESIGN-CRITIC.md` when fixture setup reveals contradictory assumptions
