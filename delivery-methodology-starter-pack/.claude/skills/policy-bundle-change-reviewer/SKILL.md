...
- **Escalate / hand off when:**
  - to `SOLUTION-ARCHITECT.md` when the change exposes engine/policy boundary confusion
  - to `DB-DESIGNER.md` when policy storage keys or lineage are unclear
  - to `TEST-DESIGNER.md` when the next question is coverage adequacy
