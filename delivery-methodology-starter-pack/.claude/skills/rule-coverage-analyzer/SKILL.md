...
- **Escalate / hand off when:**
  - to `TAX-DOMAIN-EXPERT.md` when expected policy meaning is unclear
  - to `TEST-BUILDER.md` when the next step is generating the missing tests
  - to `SOLUTION-ARCHITECT.md` when gaps reflect deeper model or boundary issues
