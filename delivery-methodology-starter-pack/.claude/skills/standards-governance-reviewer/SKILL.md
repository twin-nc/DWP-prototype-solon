...
- **Escalate / hand off when:**
  - to `DESIGN-CRITIC.md` when the main problem is structural design weakness rather than governance classification
  - to `TAX-DOMAIN-EXPERT.md` when compliance depends on policy or tax interpretation
  - to `DB-DESIGNER.md` when immutability, lineage, or migration semantics drive the concern
  - to `DEVOPS-RELEASE-ENGINEER.md` when release evidence, CI gates, rollout, or deferral handling becomes central
