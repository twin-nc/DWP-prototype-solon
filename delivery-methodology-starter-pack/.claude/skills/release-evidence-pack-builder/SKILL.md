...
- **Escalate / hand off when:**
  - to `BUSINESS-ANALYST.md` when requirement or acceptance mapping is incomplete
  - to `DB-DESIGNER.md` when migration evidence is central
  - to `SOLUTION-DESIGNER.md` when trace or documentation structure is incomplete
