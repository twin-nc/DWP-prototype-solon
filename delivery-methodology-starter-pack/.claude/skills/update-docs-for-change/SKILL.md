...
- **Escalate / hand off when:**
  - to `SOLUTION-ARCHITECT.md` when the doc updates depend on architecture decisions not yet made
  - to `DEVOPS-RELEASE-ENGINEER.md` when runbooks, release notes, or evidence docs are central
