...
- **Escalate / hand off when:**
  - to `TEST-DESIGNER.md` when the missing gates are really missing verification strategy
  - to `SOLUTION-ARCHITECT.md` when gate selection depends on architecture or contract risk
  - to `CODE-REVIEWER.md` when the main concern is code-quality enforcement
