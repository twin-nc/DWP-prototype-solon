...
- **Escalate / hand off when:**
  - to `TAX-DOMAIN-EXPERT.md` when the top authority depends on policy or legal interpretation
  - to `DEVOPS-RELEASE-ENGINEER.md` when release evidence or operational controls are part of the conflict
