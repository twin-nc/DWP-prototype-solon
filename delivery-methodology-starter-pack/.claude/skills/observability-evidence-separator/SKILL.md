...
- **Escalate / hand off when:**
  - to `SOLUTION-ARCHITECT.md` when the confusion reflects architectural boundary problems
  - to `CODE-REVIEWER.md` when the next step is fixing instrumentation patterns
  - to `DESIGN-CRITIC.md` when the design assumes logs can substitute for evidence
