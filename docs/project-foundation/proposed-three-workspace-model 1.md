...
This document defines the three-workspace model for the Business Control & Experience Layer. It is retained as unsettled platform-pivot context and is a reference for workspace structure, role separation, and workspace-level demo design. Release 1 product capability scope is governed by [`../release/release-1-capabilities.md`](../release/release-1-capabilities.md).
