...
| 3 — Breach to third-party collection | Primary — agent steps before supervisor exception queue |
...
- Third-party collection relationship managers
...
- Review third-party collection placement status and performance
...
| Source | Data provided |
|---|---|
| Strategy, Analytics & third-party collection Core Service | Champion/challenger results, KPI metrics, third-party collection placement and reconciliation data |
...
| Analytics & third-party collection DB | Historical KPI metrics, C/C results, third-party collection records and commission ledger |
...
- third-party collection performance and reconciliation reporting
...
| 3 — Breach to third-party collection | Supporting — supervisor exception queue and third-party collection reporting |
...
| 3 — Breach to third-party collection placement | Case Worker + Operations | — |
