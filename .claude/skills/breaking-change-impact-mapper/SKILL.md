...
- **Escalate / hand off when:**
  - to `devops-release-engineer` when rollout windows, deprecation handling, or release coordination dominate
  - to `business-analyst` when consumer expectations or communication obligations are unclear
