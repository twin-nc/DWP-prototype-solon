...
- isolated flaky-test triage without broader PR integration
- release-readiness decisioning only
...
- **Escalate / hand off when:**
  ...
  - to `dwp-debt-domain-expert` when expected behavior depends on domain policy interpretation
