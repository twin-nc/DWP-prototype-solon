...
- **Escalate / hand off when:**
  - to `solution-architect` when leakage risk reflects deeper boundary problems
  - to `code-reviewer` when the main next step is correcting code patterns
  - to `design-critic` when the overall design encourages unsafe data flows
