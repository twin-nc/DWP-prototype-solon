...
- **Escalate / hand off when:**
  - to `solution-architect` when classification depends on boundary or state implications
  - to `devops-release-engineer` when release gating or operational controls dominate
  - to `dwp-debt-domain-expert` when outcome sensitivity depends on policy meaning
