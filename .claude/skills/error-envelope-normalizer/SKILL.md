...
- **Escalate / hand off when:**
  - to `solution-architect` when errors reflect deeper domain or boundary problems
  - to `devops-release-engineer` when retry, dependency, or operational semantics dominate
  - to `code-reviewer` when the main next step is reviewing a concrete implementation
