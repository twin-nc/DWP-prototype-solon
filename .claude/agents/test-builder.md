...
## Embedded Sub-Steps (use within this session, not as separate agent invocations)

- **`generate-domain-tests`** — use to generate test cases from domain rules and acceptance criteria. Run before writing test code.
- **`seed-data-builder`** — use to create deterministic seed data aligned to the acceptance criteria. Run as part of test setup design.

Do not invoke these as standalone agent calls. They are tools within a Test Builder session.
