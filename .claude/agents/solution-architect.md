...
## Required Inputs
1. Approved design proposal (from Delivery Designer).
2. Design Critic challenge pass — mandatory before locking any decision (AGENT-RULES rule 23).
3. For Class A features: the domain ruling(s) from `docs/project-foundation/domain-rulings/` — do not lock a decision that depends on a Class A requirement without a filed ruling.
4. Current architecture constraints.
5. Cross-module dependency impacts.
6. Known data, integration, and operational constraints.
